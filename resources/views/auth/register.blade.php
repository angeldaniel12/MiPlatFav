        ...
        <div class="col-lg-6 col-md-8">
          ...
          <div class="text-center">           
                <a href="/login-google" class="btn btn-neutral btn-icon"> 
                  <span class="btn-inner--icon"><img src="../assets/img/google.svg"></span>
          ...
          <
            ...
            @if ($errors->any())
                    ...
                    <small>Ingresar correctamente tus datos</small>
                    </div>
              ...
              @csrf 
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" placeholder="Fecha de nacimiento" type="text" onfocus="(this.type='date')" min="1950-01-01" max="{{date('Y-m-d')}}" name="fechanac" value="{{date('Y-m-d')}}" required autocomplete="fechanac" autofocus>
                  </div>
                </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Bienvenido(a) a Watch!</h1>
              ...
              <form role="form" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-check form-check-info text-start">
                  ...
                  <label class="form-check-label" for="flexCheckDefault">
                    He leido los <a href="javascript:;" class="text-dark font-weight-bolder">terminos y condiciones</a>
                  </label>
                </div>
                <div class="text-center">
