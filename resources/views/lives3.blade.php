...
@section('content')
<div class="card-body">
                      <h5 class="card-title">Salas Streaming Social</h5>
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card h-100">
                    ...
                    <div class="card-body">
                      ...
                      <a href="{{ route ('sala12')}}" class="btn btn-outline-primary">Transmitir</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  ...
                  <img class="card-img-top" src="../assets/img/imglives/cine.jpg" alt="Card image cap" />
                    <div class="card-body">
                      ...
                      <p class="card-text">Empezaras a transmitir</p>
                      <a href="{{ route ('sala13')}}" class="btn btn-outline-success">Transmitir</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card h-100">
                    ...
                    <div class="card-body">
                      ...
                      <a href="{{ route ('sala14')}}" class="btn btn-outline-warning">Transmitir</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  ...
                  <img class="card-img-top" src="../assets/img/imglives/sociedad1.jpg" alt="Card image cap" />
                    <div class="card-body">
                      ...
                      <h6 class="card-subtitle text-muted"></h6>
                      <p class="card-text">Empezaras a transmitir</p>
                      <a href="{{ route ('sala15')}}" class="btn btn-outline-dark">Transmitir</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card h-100">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">
                      Empezaras a transmitir</p>
                      <a href="{{ route ('sala16')}}" class="btn btn-outline-warning">Transmitir</a>
                    </div>
                  </div>
                </div>
