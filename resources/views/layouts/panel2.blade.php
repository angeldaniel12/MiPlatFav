      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="#">
            ...
            <span class="nav-link-text ms-1">Mis REELS</span>
          </a>
        </li>
        @endcan
        <li class="nav-item">
      ...
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <li class="nav-item dropdown pe-2 d-flex align-items-center">
           ...
           <span class="ml-3 pull-right text-muted text-sm">Notificaciones No Leidas</span>
           <!-- <span class="dropdown-header noti-title">Notificaciones Leidas</span> -->
            @forelse (auth()->user()->unreadNotifications as $notificacion)
            
            <a class="dropdown-item" href="#">
              <i class="ni ni-email-83"></i>{{$notificacion->data['title']}}
            ...
            <div class="dropdown-divider"> </div>
            <span class="ml-3 pull-right text-muted text-sm">Notificaciones Leidas</span>
            ...
            @endforelse 
            <div class="dropdown-divider"></div>
            <a class="dropdown-item dropdown-footer" href="{{route('markAsRead')}}">Marcar como leidas</a>
          </div>
          </li>
